...
function createUser(user,socketID, callback){
    ...
    var query = "INSERT INTO arcturus.user (userName, userPassword, userEmail, refID, userSocket, statusID) ";
    query += "values (" + userName + ", " + userPass + ", " + userEmail +" , " + userRefID +" , "+ socketID +" , 2 )";
    ...
    mySession.then((mySession) => {
        ...
        mySession.sql(query).execute().then((results) => {
            ...
            query = "INSERT INTO arcturus.userStatus (userID, statusID, userStatusCode, userStatusValidated) values ('" + userID + "', '1'," + mysql.escape(veriCode) + ",'false')";
